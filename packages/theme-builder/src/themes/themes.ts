...
import { BaseColorPreset } from './base-colors'
import type { ThemeBase, ThemePreset } from '@element-kit/ui'
...
export const THEMEPRESETS: (ThemeBase & {
  id: ThemePreset
  name: string
  mode: ThemeMode
})[] = _THEMES
...
export type Theme = (typeof THEMEPRESETS)[number]
